      ...
      <div className="w-full sm:max-w-lg md:max-w-2xl overflow-hidden" style={{ borderRadius: "20px", backgroundColor: "white", boxShadow: "0 20px 25px -5px rgba(0,0,0,0.1)" }}>
        ...
        <div className="px-6 py-6 space-y-6">
          ...
          <div className="space-y-3 pt-2">
            <button
              onClick={() => navigate(`/request/building_clearance/${successData.id}?fromSubmit=1`)}
  ...
  const fetchAvailableSlots = async (date: string) => {
    ...
    try {
      const res = await axios.get("https://westrembomis.onrender.com/api/schedule-slots", {
        ...
        params: { document_type: "building_clearance", date },
      });
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="space-y-1.5">
                  ...
                  />
                  {errors.establishment && <p className="mt-1 text-xs text-red-500 flex items-center gap-1"><AlertTriangle className="w-3 h-3" />{errors.establishment}</p>}
                </div>
                <div className="space-y-1.5">
                ...
                <div className="space-y-1.5">
                  ...
                  />
                  {errors.purpose_details && <p className="mt-1 text-xs text-red-500 flex items-center gap-1"><AlertTriangle className="w-3 h-3" />{errors.purpose_details}</p>}
                </div>
              </div>
            </div>
