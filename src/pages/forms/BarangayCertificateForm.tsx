...
const SuccessModal = ({
  ...
  // Format the schedule time nicely if it's raw HH:mm:ss
      ...
      <div className="w-full sm:max-w-lg md:max-w-2xl overflow-hidden" style={{ borderRadius: "20px", backgroundColor: "white", boxShadow: "0 20px 25px -5px rgba(0,0,0,0.1)" }}>
        ...
        <div className="px-6 py-6 space-y-6">
          ...
          <div className="space-y-3 pt-2">
            <button onClick={() => navigate(`/request/barangay_certificate/${successData.id}?fromSubmit=1`)} className="w-full py-3 text-sm font-bold text-white rounded-lg hover:opacity-90 transition-opacity" style={{ backgroundColor: "#0f2a5e" }}>
              View My Request
            </button>
            <button
              onClick={() => navigate("/")}
  ...
  const fetchAvailableSlots = async (date: string) => {
    ...
    try {
      const res = await axios.get("https://westrembomis.onrender.com/api/schedule-slots", {
        ...
        params: { document_type: "barangay_certificate", date },
      });
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-6">
                <div className="space-y-1.5">
                  ...
                  <Input type="text" value={formData.extension} readOnly={!isDependent} disabled={!isDependent} placeholder="Jr., Sr."
                    onChange={isDependent ? (e) => upd("extension", e.target.value) : undefined}
                    className={isDependent ? editableInputCls : readonlyInputCls}
                    style={isDependent ? dependentEditableStyle : readonlyStyle}
                    onFocus={isDependent ? (e) => (e.currentTarget.style.borderBottomColor = "#c2467d") : undefined}
                    onBlur={isDependent ? (e) => (e.currentTarget.style.borderBottomColor = "#fcd34d") : undefined}
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-1.5">
                  ...
                  {isDependent ? (
                    <Select value={formData.street} onValueChange={(v) => { const matched = streets.find((s) => toUpperCase(s.name) === v); setFormData((p) => ({ ...p, street: v, zone: matched?.sitio ? toUpperCase(matched.sitio) : "" })); }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                <div className="space-y-1.5">
                  ...
                  <Input placeholder="Name of house owner" value={formData.house_owner} readOnly={!isDependent} disabled={!isDependent}
                    onChange={isDependent ? (e) => upd("house_owner", e.target.value) : undefined}
                    className={isDependent ? editableInputCls : readonlyInputCls}
                    style={isDependent ? dependentEditableStyle : readonlyStyle}
                    onFocus={isDependent ? (e) => (e.currentTarget.style.borderBottomColor = "#c2467d") : undefined}
                    onBlur={isDependent ? (e) => (e.currentTarget.style.borderBottomColor = "#fcd34d") : undefined}
                ...
                <div className="space-y-1.5">
                  ...
                  {isDependent ? (
                    <Select value={formData.relationship_to_owner} onValueChange={(v) => setFormData((p) => ({ ...p, relationship_to_owner: v }))}>
                      <SelectTrigger className="rounded-none border-0 border-b-2 px-0 focus:ring-0 text-sm" style={dependentEditableStyle} onFocus={(e) => (e.currentTarget.style.borderBottomColor = "#c2467d")} onBlur={(e) => (e.currentTarget.style.borderBottomColor = "#fcd34d")}>
            ...
            <div>
              ...
              <div className="mt-6 space-y-1.5">
                ...
                <Select value={formData.purpose} onValueChange={(v) => { setFormData((p) => ({ ...p, purpose: v })); setErrors((prev) => ({ ...prev, purpose: "" })); }}>
                  ...
                  <SelectContent>
                    {certificatePurposes.map((p) => <SelectItem key={p} value={p}>{p}</SelectItem>)}
                  </SelectContent>
                </Select>
