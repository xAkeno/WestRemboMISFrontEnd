...
export const BarangayClearanceFindModal = ({updateModal,updateSelect}:Props) => {
    ...
    console.log(json)
    return (
        <div className="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 bg-gray-100 w-[95%] md:inset-0 h-[calc(100%-1rem)] max-h-[80%] mx-auto my-auto bg-neutral-primary-soft shadow-xs rounded-base border border-default">
        <div className="">
                {/* Top Bar */}
            ...
            <table className="w-full text-sm text-left rtl:text-right text-body">
                ...
                <tr>
                    ...
                    {
                        ["bcert Number","Issue date","Surname","First name","Middle name","Ext","Block No.","Street","Zone","DOB","POB","Purpose","Remark","Action"].map((item) => (<th className="px-6 py-3 font-medium">{item}</th>))
                    }
                ...
                {json.map((item, i) => (
                    ...
                    <td className="px-6 py-4">{item.issued_date}</td>
                    <td className="px-6 py-4">{item.surname}</td>
                    <td className="px-6 py-4">{item.first_name}</td>
                    <td className="px-6 py-4">{item.middle_name}</td>
                    <td className="px-6 py-4">{item.ext_name}</td>
                    <td className="px-6 py-4">{item.house_block_lot_no}</td>
                    <td className="px-6 py-4">{item.street}</td>
                    <td className="px-6 py-4">{item.zone}</td>
                    <td className="px-6 py-4">{item.dob}</td>
                    <td className="px-6 py-4">{item.pob}</td>
