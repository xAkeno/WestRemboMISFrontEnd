...
export const BarangayBusinessFindModal = ({updateModal,updateSelect}:Props) => {
        ...
        <div className="">
            ...
            <table className="w-full text-sm text-left rtl:text-right text-body">
                ...
                <tr>
                    ...
                    {
                        ["brgyBusinessNo","issuedDate","prefix","Surname","First name","Middle name","Ext","Street","Zone","businessName","businessType","businessDetails","capital","houseBlockLotNo","OR NO","inspectedBy","dateOfInspection","inspectionRemarks","inspectedRemarks","dateInspected","inspectedNote","created_at","updated_at","Action"].map((item) => (<th className="px-6 py-3 font-medium">{item}</th>))
                    }
                ...
                {json.map((item, i) => (
                    ...
                    <td className="px-6 py-4">{item.brgyBusinessNo}</td>
                    ...
                    <td className="px-6 py-4">{item.ext}</td>
                    ...
                    <td className="px-6 py-4">{item.businessDetails}</td>
                    <td className="px-6 py-4">{item.capital}</td>
                    <td className="px-6 py-4">{item.houseBlockLotNo}</td>
                    <td className="px-6 py-4">{item.orNo}</td>
                    <td className="px-6 py-4">{item.inspectedBy}</td>
                    <td className="px-6 py-4">{item.dateOfInspection}</td>
                    <td className="px-6 py-4">{item.inspectionRemarks}</td>
                    <td className="px-6 py-4">{item.dateInspected}</td>
                    <td className="px-6 py-4">{item.inspectedNote}</td>
