      ...
      {isOpen && (
        ...
        >
          ...
          <div className="p-4" style={{ borderBottom: "1px solid #fce7f3" }}>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full overflow-hidden flex-shrink-0" style={{ border: "2px solid #d45ea3" }}>
                <img className="w-full h-full object-cover" src={"https://westrembomis.onrender.com/storage/" + self.url_photo} alt="Avatar" />
              </div>
          ...
          <ul className="p-2 space-y-0.5">
            <li>
              <a href="/profile" className="flex items-center gap-2.5 w-full px-3 py-2.5 rounded-xl text-sm text-foreground transition-colors duration-150 hover:bg-[#fdf2f8] hover:text-[#d45ea3] group">
            ...
            <li>
              <a href="/myrequest" className="flex items-center gap-2.5 w-full px-3 py-2.5 rounded-xl text-sm text-foreground transition-colors duration-150 hover:bg-[#fdf2f8] hover:text-[#d45ea3] group">
                <svg className="w-4 h-4 text-muted-foreground group-hover:text-[#d45ea3]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            {self.role === "ADMIN" && (
              <li>
                <a href="/dashboard" className="flex items-center gap-2.5 w-full px-3 py-2.5 rounded-xl text-sm text-foreground transition-colors duration-150 hover:bg-[#fdf2f8] hover:text-[#d45ea3] group">
                  <svg className="w-4 h-4 text-muted-foreground group-hover:text-[#d45ea3]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <li>
              ...
              >
                ...
                <div className="ml-auto relative w-9 h-5 rounded-full transition-colors duration-200 flex-shrink-0" style={{ backgroundColor: isDark ? "#d45ea3" : "#e2e8f0" }}>
                  <div className="absolute top-0.5 w-4 h-4 rounded-full bg-white shadow-sm transition-all duration-200" style={{ left: isDark ? "calc(100% - 18px)" : "2px" }} />
                </div>
              </button>
            </li>
