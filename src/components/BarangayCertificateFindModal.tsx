...
export const BarangayCertificateFindModal = ({updateModal,updateSelect}:Props) => {
            ...
            <table className="w-full text-sm text-left rtl:text-right text-body">
                ...
                <tr>
                    ...
                    <div className="flex items-center">
                        ...
                        <th key={index} className="px-6 py-3 font-medium text-left">
                            {item}
                        </th>
                        ))}
                ...
                {json.map((item, i) => (
                    ...
                    <td className="px-6 py-4">{item.place_of_birth}</td>
                    <td className="px-6 py-4">{item.age}</td>
                    <td className="px-6 py-4">{item.prefix}</td>
                    <td className="px-6 py-4">{item.punong_barangay}</td>
                    <td className="px-6 py-4">{item.for_the_punong_barangay || ""}</td>
                    <td className="px-6 py-4">{item.registered_voter}</td>
                    <td className="px-6 py-4">{item.house_owner}</td>
                    <td className="px-6 py-4">{item.relationship_to_owner || ""}</td>
                    <td className="px-6 py-4">{item.period_of_residency || ""}</td>
                    <td className="px-6 py-4">{item.purpose}</td>
                    <td className="px-6 py-4">{item.purpose_details || ""}</td>
